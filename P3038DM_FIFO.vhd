...
-- Module  Version: 5.8
--C:\lscc\diamond\3.11_x64\ispfpga\bin\nt64\scuba.exe -w -n P3038DM_FIFO -lang vhdl -synth synplify -bus_exp 7 -bb -arch xo2c00 -type ebfifo -depth 16 -width 32 -rwidth 32 -pfu_fifo -no_enable -pe 2 -pf 10 
...
architecture Structure of P3038DM_FIFO is
...
begin
    ...
    LUT4_3: ROM16X1A
        ...
        port map (AD3=>ae_setcount_4, AD2=>rcount_4, AD1=>w_gcount_r24, 
    ...
    ae_set_ctr_2: CU2
        port map (CI=>co1_4, PC0=>ae_setcount_4, PC1=>scuba_vlo, 
            CO=>co2_2, NC0=>iae_setcount_4, NC1=>open);
    ...
    ae_set_cmp_0: AGEB2
        port map (A0=>ae_setcount_0, A1=>ae_setcount_1, B0=>wcount_r0, 
            B1=>w_g2b_xor_cluster_0, CI=>cmp_ci_2, GE=>co0_5);
    ...
    ae_set_cmp_2: AGEB2
        port map (A0=>ae_set_cmp_set, A1=>scuba_vlo, B0=>ae_set_cmp_clr, 
            B1=>scuba_vlo, CI=>co1_5, GE=>ae_set_d_c);
    ...
    af_set_ctr_2: CU2
        port map (CI=>co1_6, PC0=>af_setcount_4, PC1=>scuba_vlo, 
            CO=>co2_3, NC0=>iaf_setcount_4, NC1=>open);
    ...
    af_set_cmp_0: AGEB2
        port map (A0=>af_setcount_0, A1=>af_setcount_1, B0=>rcount_w0, 
            B1=>r_g2b_xor_cluster_0, CI=>cmp_ci_3, GE=>co0_7);
    ...
    af_set_cmp_2: AGEB2
        port map (A0=>af_set_cmp_set, A1=>scuba_vlo, B0=>af_set_cmp_clr, 
            B1=>scuba_vlo, CI=>co1_7, GE=>af_set_c);
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of P3038DM_FIFO is
    for Structure
